...
HRRR_df <- read.csv2(paste0('C:\\Users\\ovpr.nimamaso\\Box\\Desktop\\',
                            'GEO511 - Spatial Data Science\\Project\\Zolal_complete_data',
                            '\\daily_df_HRRR.csv'))
ERA5_df <- read.csv2(paste0('C:\\Users\\ovpr.nimamaso\\Box\\Desktop\\',
                            'GEO511 - Spatial Data Science\\Project\\Zolal_complete_data',
                            '\\daily_df_ERA5.csv')) %>% 
...
plot(mask(monthly_min_Diff_brick,ny_bound),nr=4)

monthly_max_Diff_brick=brick(monthly_max_Diff)
names(monthly_max_Diff_brick)=ls_names
plot(mask(monthly_max_Diff_brick,ny_bound),nr=4)
```
